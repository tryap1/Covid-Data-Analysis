...
outputlabel1.place(relwidth = 1, relheight = 0.5)

outputlabel2 = tk.Label(frame2, font = 8,anchor = "w", justify = 'left')
outputlabel2.place(relx = 0,rely = 0.5,relwidth = 1, relheight = 0.5)
